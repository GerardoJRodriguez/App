...
public class SmsReceiver extends BroadcastReceiver
{
    ...
    private void sendEmail2 (Context context )
    {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO);
        emailIntent.setData(Uri.parse("mailto: aberkane.kahina@gmail.com"));
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "android Test");
        emailIntent.putExtra(Intent.EXTRA_TEXT   , "Hi kahina , it's a success ");
        context.startActivity(Intent.createChooser(emailIntent, "Send feedback"));
        Toast.makeText(context, "the email was sent ", Toast.LENGTH_SHORT).show();

        /*Intent i = new Intent(Intent.ACTION_SENDTO);
        i.setType("text/plain");
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"aberkane.kahina@gmail.com"});
        i.putExtra(Intent.EXTRA_SUBJECT, "android Test");
        i.putExtra(Intent.EXTRA_TEXT   , "Hi kahina , it's a success ");
        try {
